...
const getMonthlySummary = (propertyId) => {
  const summary = {};
...
<div className="space-y-8">
  <div>
    ...
    {airbnbProperties.map((p) => (
      <div key={p.id} className="border-2 border-gray-600 p-4 mb-4 rounded-xl shadow-md bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          <div className="border rounded p-3">
            ...
            <p className="text-lg font-semibold">${getAirbnbRevenue(p.id)}</p>
          </div>

          <div className="border rounded p-3">
            <p className="text-sm text-gray-500">Expense</p>
            <p className="text-lg font-semibold">${getAirbnbExpense(p.id)}</p>
          </div>
        ...
        {expandedProperties[p.id] && (
          ...
          >
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {bookings
                  .filter((b) => b.property_id === p.id)
                  .map((b) => (
                    <div key={b.id} className="text-sm border rounded p-3 bg-gray-50">
                      <div>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {Object.entries(getMonthlySummary(p.id)).map(([month, data]) => (
                  <div key={month} className="text-sm border p-2 mb-1 rounded bg-gray-50">
    ...
    {longTermProperties.map((p) => (
      <div key={p.id} className="border-2 border-gray-600 p-4 mb-4 rounded-xl shadow-md bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="border rounded p-3">
            <p className="text-sm text-gray-500">Revenue</p>
            <p className="text-lg font-semibold">${p.monthly_rent || 0}</p>
          </div>

          <div className="border rounded p-3">
            <p className="text-sm text-gray-500">Expense</p>
            <p className="text-lg font-semibold">${p.monthly_expense || 0}</p>
          </div>
